...
namespace Blood
{
	...
	internal class buttonburstASystem : ParticleSystem
	{
		// Token: 0x06000159 RID: 345 RVA: 0x000307F1 File Offset: 0x0002E9F1
		public buttonburstASystem(Game game, ContentManager content)
			: base(game, content)
		{
		}

		// Token: 0x0600015A RID: 346 RVA: 0x000307FC File Offset: 0x0002E9FC
