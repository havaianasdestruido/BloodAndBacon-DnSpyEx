...
namespace Blood
{
	...
	{
		// Token: 0x0600006E RID: 110 RVA: 0x00019798 File Offset: 0x00017998
		...
		// Token: 0x0600006F RID: 111 RVA: 0x0001A560 File Offset: 0x00018760
		public void LoadContent(ScreenManager sc, ContentManager cc)
		{
			...
			this.fireball = default(Cutty4.hole);
			...
			this.chunk = default(Cutty4.shell);
			this.chunk.max = 0;
			this.chunk.type = 0;
			...
			this.faceChunk = default(Cutty4.shell);
			...
			this.assChunk = default(Cutty4.shell);
			this.assChunk.max = 0;
		...
		// Token: 0x06000070 RID: 112 RVA: 0x00020604 File Offset: 0x0001E804
		...
		// Token: 0x06000071 RID: 113 RVA: 0x0002067C File Offset: 0x0001E87C
		...
		// Token: 0x06000072 RID: 114 RVA: 0x000206F3 File Offset: 0x0001E8F3
		...
		// Token: 0x06000073 RID: 115 RVA: 0x00020724 File Offset: 0x0001E924
		public void SetTangents(ref Curve x, ref Curve y)
		{
			for (int i = 0; i < x.Keys.Count; i++)
			{
				...
				Cutty4.SetCurveKeyTangent(ref curveKey, ref curveKey3, ref curveKey2);
				x.Keys[i] = curveKey3;
				curveKey = y.Keys[num];
		...
		// Token: 0x06000074 RID: 116 RVA: 0x00020804 File Offset: 0x0001EA04
		...
		// Token: 0x06000075 RID: 117 RVA: 0x0002088B File Offset: 0x0001EA8B
		...
		// Token: 0x06000076 RID: 118 RVA: 0x000208CC File Offset: 0x0001EACC
		...
		// Token: 0x06000077 RID: 119 RVA: 0x00021200 File Offset: 0x0001F400
		private void addBulletHole(Vector2 p1, Vector2 p2, Vector2 p3, Vector2 p4, float sendY, float sendX, int bonehit)
		{
			...
			Cutty4.xcoord = (int)num6;
			Cutty4.ycoord = (int)num9;
		...
		// Token: 0x06000078 RID: 120 RVA: 0x00021617 File Offset: 0x0001F817
		...
		// Token: 0x06000079 RID: 121 RVA: 0x00021658 File Offset: 0x0001F858
		...
		// Token: 0x0600007A RID: 122 RVA: 0x000216D8 File Offset: 0x0001F8D8
		...
		// Token: 0x0600007B RID: 123 RVA: 0x00021824 File Offset: 0x0001FA24
		...
		// Token: 0x0600007C RID: 124 RVA: 0x00021970 File Offset: 0x0001FB70
		...
		// Token: 0x0600007D RID: 125 RVA: 0x00021ABC File Offset: 0x0001FCBC
		...
		// Token: 0x0600007E RID: 126 RVA: 0x00021D2C File Offset: 0x0001FF2C
		...
		// Token: 0x0600007F RID: 127 RVA: 0x00021E44 File Offset: 0x00020044
		...
		// Token: 0x06000080 RID: 128 RVA: 0x00022098 File Offset: 0x00020298
		...
		// Token: 0x06000081 RID: 129 RVA: 0x000223C0 File Offset: 0x000205C0
		...
		// Token: 0x06000082 RID: 130 RVA: 0x00022618 File Offset: 0x00020818
		...
		// Token: 0x06000083 RID: 131 RVA: 0x000227AC File Offset: 0x000209AC
		...
		// Token: 0x06000084 RID: 132 RVA: 0x00022BF8 File Offset: 0x00020DF8
			...
			if (!this.newAction && Cutty4.gonnaHealindex == -1)
			{
				...
				if (this.healCount > 0 && (flag2 || flag3) && this.gonnaHealDelay <= 0f)
				{
					...
					if (num7 <= num4)
					{
						...
						float num11 = Cutty4.WrapAngle(num6 - num10);
						float num12 = Cutty4.WrapAngle(num6 + 3.14f - num10);
			...
			if (this.targetWait <= 0 && !this.newAction)
			{
				...
				if (this.curveIndex != num || this.homing > 10)
				{
					...
					if (num13 < this.break1)
					{
						...
						if (this.playerHealth > 0f && Cutty4.homingLocal == -1)
						{
		...
		// Token: 0x06000085 RID: 133 RVA: 0x0002389C File Offset: 0x00021A9C
		...
		// Token: 0x06000086 RID: 134 RVA: 0x0002391C File Offset: 0x00021B1C
		...
		// Token: 0x06000087 RID: 135 RVA: 0x00023968 File Offset: 0x00021B68
		private void pigBones(Vector3 lookVec, ref float[,] heights)
		{
			...
			float num3 = Cutty4.WrapAngle(num2 - this.piglook);
			num3 = MathHelper.Clamp(num3, -0.013f, 0.013f);
			this.piglook = Cutty4.WrapAngle(this.piglook + num3);
			...
			if (!this.cuttyisDead)
			{
				...
				float num6 = Cutty4.WrapAngle(num2 - this.cuttyRot);
				float num7 = 0.065f;
				if (this.homing > 0)
				{
					num7 = 0.065f;
					num6 = MathHelper.Clamp(num6, -num7, num7);
					this.cuttyRot = Cutty4.WrapAngle(this.cuttyRot + num6);
				}
				if (this.attack1)
				{
					num7 = 0.06f;
				...
				if (this.cuttyHeal)
				{
					...
					{
						num6 = Cutty4.WrapAngle(this.cuttyHealrot - this.cuttyRot);
						num7 = 0.01f;
					}
		...
		// Token: 0x06000088 RID: 136 RVA: 0x00024F9C File Offset: 0x0002319C
		...
		// Token: 0x06000089 RID: 137 RVA: 0x00025160 File Offset: 0x00023360
		private void pigDying()
		{
			...
			else if (!this.cuttyDyingWalk)
			{
				...
				float num3 = Cutty4.WrapAngle(this.cuttyDeadrot - this.cuttyRot);
				num3 = MathHelper.Clamp(num3, -0.06f, 0.06f);
				this.cuttyRot = Cutty4.WrapAngle(this.cuttyRot + num3);
			}
		}

		// Token: 0x0600008A RID: 138 RVA: 0x000254A4 File Offset: 0x000236A4
		private void pigHealing(ref float[,] heights)
		{
			...
			if (this.healWait1 > 0f)
			{
				this.fps = 0.4f;
				float num;
				Cutty4.GetHeightFast(ref heights, new Vector2(this.cuttyPos.X, this.cuttyPos.Z), out num);
				this.cuttyPos.Y = num;
			}
			if (this.healWait2 > 0f && this.healWait1 <= 0f && this.healtimer <= this.healduration)
			{
				...
				float num3;
				Cutty4.GetHeightFast(ref heights, new Vector2(this.cuttyPos.X, this.cuttyPos.Z), out num3);
			...
			if (this.healWait2 > 0f && this.healtimer > this.healduration)
			{
				...
				float num4;
				Cutty4.GetHeightFast(ref heights, new Vector2(this.cuttyPos.X, this.cuttyPos.Z), out num4);
		...
		// Token: 0x0600008B RID: 139 RVA: 0x00025940 File Offset: 0x00023B40
		private void pigAttack(ref float[,] heights)
		{
			...
			{
				this.attack1 = false;
				int num5 = 100 + Cutty4.cuttyCount * 150;
				int num6 = Cutty4.cuttyCount * 320;
		...
		// Token: 0x0600008C RID: 140 RVA: 0x00025D10 File Offset: 0x00023F10
		...
		// Token: 0x0600008D RID: 141 RVA: 0x00025DD4 File Offset: 0x00023FD4
		...
		// Token: 0x0600008E RID: 142 RVA: 0x00025FF0 File Offset: 0x000241F0
		...
		// Token: 0x0600008F RID: 143 RVA: 0x0002623C File Offset: 0x0002443C
		...
		// Token: 0x06000090 RID: 144 RVA: 0x000262BC File Offset: 0x000244BC
		...
		// Token: 0x06000091 RID: 145 RVA: 0x000267E9 File Offset: 0x000249E9
		...
		// Token: 0x06000092 RID: 146 RVA: 0x00026814 File Offset: 0x00024A14
		...
		// Token: 0x06000093 RID: 147 RVA: 0x000268C0 File Offset: 0x00024AC0
		...
		// Token: 0x06000094 RID: 148 RVA: 0x00026B94 File Offset: 0x00024D94
		...
		// Token: 0x06000095 RID: 149 RVA: 0x00026CA3 File Offset: 0x00024EA3
		public void DrawFireBall()
		{
			this.DrawGrenadeExplosion(ref this.fireball, Matrix.Identity);
		}

		// Token: 0x06000096 RID: 150 RVA: 0x00026CB8 File Offset: 0x00024EB8
		...
		// Token: 0x06000097 RID: 151 RVA: 0x00026E68 File Offset: 0x00025068
		...
		// Token: 0x06000098 RID: 152 RVA: 0x00027134 File Offset: 0x00025334
		...
		// Token: 0x06000099 RID: 153 RVA: 0x00027270 File Offset: 0x00025470
		...
		// Token: 0x0600009A RID: 154 RVA: 0x00027314 File Offset: 0x00025514
		...
		// Token: 0x0600009B RID: 155 RVA: 0x000273EC File Offset: 0x000255EC
		...
		// Token: 0x0600009C RID: 156 RVA: 0x00027524 File Offset: 0x00025724
		private void shockWave(ref float[,] heights)
		{
			...
			for (float num4 = 0f; num4 < 6.28f; num4 += num2)
			{
				...
				Cutty4.GetHeightFast(ref heights, new Vector2(vector.X, vector.Z), out vector.Y);
		...
		// Token: 0x0600009D RID: 157 RVA: 0x000277D4 File Offset: 0x000259D4
		...
		// Token: 0x0600009E RID: 158 RVA: 0x00027880 File Offset: 0x00025A80
		...
		// Token: 0x0600009F RID: 159 RVA: 0x000279E4 File Offset: 0x00025BE4
		...
		// Token: 0x060000A0 RID: 160 RVA: 0x00027BA8 File Offset: 0x00025DA8
		private static void GetHeightFast(ref float[,] heights, Vector2 position, out float height)
		{
			int num = (int)MathHelper.Clamp(position.X / Cutty4.unit, 0f, (float)(Cutty4.bitmap - 2));
			int num2 = (int)MathHelper.Clamp(position.Y / Cutty4.unit, 0f, (float)(Cutty4.bitmap - 2));
			float num3 = position.X % Cutty4.unit / Cutty4.unit;
			float num4 = position.Y % Cutty4.unit / Cutty4.unit;
		...
		private Cutty4.hitStream hitstreamTemp = default(Cutty4.hitStream);
		...
		public Cutty4.conductor tempConduct = default(Cutty4.conductor);

		// Token: 0x040004B9 RID: 1209
		private Cutty4.conductor cuttyStruct = default(Cutty4.conductor);

		// Token: 0x040004BA RID: 1210
		private Cutty4.conductor cuttyStruct_send = default(Cutty4.conductor);
		...
		public struct hitStream : IVertexType
		{
			...
			// (get) Token: 0x060000A2 RID: 162 RVA: 0x00027E0A File Offset: 0x0002600A
			VertexDeclaration IVertexType.VertexDeclaration
			{
				get
				{
					return Cutty4.hitStream.VertexDeclaration;
				}
			}
		...
		public struct instancedObject : IVertexType
		{
			...
			// (get) Token: 0x060000A4 RID: 164 RVA: 0x00027EB7 File Offset: 0x000260B7
			VertexDeclaration IVertexType.VertexDeclaration
			{
				get
				{
					return Cutty4.instancedObject.InstanceVertexDeclaration;
				}
			}
