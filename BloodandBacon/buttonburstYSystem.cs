...
namespace Blood
{
	...
	internal class buttonburstYSystem : ParticleSystem
	{
		// Token: 0x06000157 RID: 343 RVA: 0x000306BB File Offset: 0x0002E8BB
		public buttonburstYSystem(Game game, ContentManager content)
			: base(game, content)
		{
		}

		// Token: 0x06000158 RID: 344 RVA: 0x000306C8 File Offset: 0x0002E8C8
